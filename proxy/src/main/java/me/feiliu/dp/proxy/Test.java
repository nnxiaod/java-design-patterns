...
public class Test {
     ...
     *
     ...
     com.sun.proxy.$Proxy0 extends java.lang.reflect.Proxy implements me.feiliu.dp.proxy.BusinessProcessor {
    ...
    public static void main(String[] args) {
        ...
        BusinessProcessor bp = (BusinessProcessor) Proxy
                .newProxyInstance(businessProcessor.getClass().getClassLoader(), businessProcessor.getClass().getInterfaces(), handler);
        bp.processBusiness();
